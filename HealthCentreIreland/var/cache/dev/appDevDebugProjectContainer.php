...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->normalizedIds = array(
            ...
            'appbundle\\controller\\illnesscontroller' => 'AppBundle\\Controller\\IllnessController',
        ...
        $this->methodMap = array(
            '1_c81ae542386ffdf5a97fb9b1bdcec465b5ac6aba3d4e981fd9919c94e0849f3f' => 'get1C81ae542386ffdf5a97fb9b1bdcec465b5ac6aba3d4e981fd9919c94e0849f3fService',
            '2_c81ae542386ffdf5a97fb9b1bdcec465b5ac6aba3d4e981fd9919c94e0849f3f' => 'get2C81ae542386ffdf5a97fb9b1bdcec465b5ac6aba3d4e981fd9919c94e0849f3fService',
            'AppBundle\\Controller\\DefaultController' => 'getAppBundle_Controller_DefaultControllerService',
            'AppBundle\\Controller\\IllnessController' => 'getAppBundle_Controller_IllnessControllerService',
            ...
            'AppBundle\\Form\\MemberType' => 'getAppBundle_Form_MemberTypeService',
        ...
        $this->privates = array(
            '1_c81ae542386ffdf5a97fb9b1bdcec465b5ac6aba3d4e981fd9919c94e0849f3f' => true,
            '2_c81ae542386ffdf5a97fb9b1bdcec465b5ac6aba3d4e981fd9919c94e0849f3f' => true,
    ...
    /**
     * Gets the public 'AppBundle\Controller\IllnessController' shared autowired service.
     *
     * @return \AppBundle\Controller\IllnessController
     */
    protected function getAppBundle_Controller_IllnessControllerService()
    {
        return $this->services['AppBundle\Controller\IllnessController'] = new \AppBundle\Controller\IllnessController();
    }
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_c81ae542386ffdf5a97fb9b1bdcec465b5ac6aba3d4e981fd9919c94e0849f3f']) ? $this->services['1_c81ae542386ffdf5a97fb9b1bdcec465b5ac6aba3d4e981fd9919c94e0849f3f'] : $this->get1C81ae542386ffdf5a97fb9b1bdcec465b5ac6aba3d4e981fd9919c94e0849f3fService()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_c81ae542386ffdf5a97fb9b1bdcec465b5ac6aba3d4e981fd9919c94e0849f3f']) ? $this->services['2_c81ae542386ffdf5a97fb9b1bdcec465b5ac6aba3d4e981fd9919c94e0849f3f'] : $this->get2C81ae542386ffdf5a97fb9b1bdcec465b5ac6aba3d4e981fd9919c94e0849f3fService()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'member_form', 'user' => 'root', 'password' => 'dbpassword', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_208356402a22155929a10af7f1a9ac55bc2b7bea1299e955c7151ed111af57d3');
    ...
    {
        return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\MemberType' => function () {
            return ${($_ = isset($this->services['AppBundle\Form\MemberType']) ? $this->services['AppBundle\Form\MemberType'] : $this->getAppBundle_Form_MemberTypeService()) && false ?: '_'};
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/(login|register)$');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/registration-form-submission$');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/illness)$');
        ...
        $o = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'ThisTokenIsNotSoSecretChangeIt', 'main', array('lifetime' => 604800, 'path' => '/', 'name' => 'REMEMBERME', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);
        ...
        $r = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($g, $n, array(), $a);
        $r->setOptions(array('login_path' => 'login', 'failure_path' => 'login', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $s = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $h, $q, $n, 'main', new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler(new \AppBundle\Security\AuthenticationSuccessHandler($n, array(), ${($_ = isset($this->services['session.flash_bag']) ? $this->services['session.flash_bag'] : $this->getSession_FlashBagService()) && false ?: '_'}), array('login_path' => 'login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false), 'main'), $r, array('check_path' => 'login', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $d, NULL);
        $s->setRememberMeServices($o);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($m, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $c, 1 => ${($_ = isset($this->services['security.user.provider.concrete.in_memory']) ? $this->services['security.user.provider.concrete.in_memory'] : $this->getSecurity_User_Provider_Concrete_InMemoryService()) && false ?: '_'}, 2 => ${($_ = isset($this->services['security.user.provider.concrete.db_provider']) ? $this->services['security.user.provider.concrete.db_provider'] : $this->getSecurity_User_Provider_Concrete_DbProviderService()) && false ?: '_'}), 'main', $a, $d, $e), 2 => $p, 3 => $s, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($b, $o, $h, $a, $d, true, $q), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5a2fe733b312e4.98897248', $a, $h), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, ${($_ = isset($this->services['debug.security.access.decision_manager']) ? $this->services['debug.security.access.decision_manager'] : $this->getDebug_Security_Access_DecisionManagerService()) && false ?: '_'}, $m, $h)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $e, $n, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($g, $n, 'login', false), NULL, NULL, $a, false), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main', 'security.user_checker', 'security.request_matcher.a64d671f18e5575531d76c1d1154fdc4476cb8a79c02ed7a3469178c6d7b96b5ed4e60db', true, false, 'security.user.provider.concrete.chain_provider', 'main', 'security.authentication.form_entry_point.main', NULL, NULL, array(0 => 'logout', 1 => 'form_login', 2 => 'remember_me', 3 => 'anonymous')));
    }
    ...
    {
        return $this->services['session'] = new \Symfony\Component\HttpFoundation\Session\Session(${($_ = isset($this->services['session.storage.native']) ? $this->services['session.storage.native'] : $this->get('session.storage.native')) && false ?: '_'}, new \Symfony\Component\HttpFoundation\Session\Attribute\AttributeBag(), ${($_ = isset($this->services['session.flash_bag']) ? $this->services['session.flash_bag'] : $this->getSession_FlashBagService()) && false ?: '_'});
    }
    ...
    /**
     * Gets the private '1_c81ae542386ffdf5a97fb9b1bdcec465b5ac6aba3d4e981fd9919c94e0849f3f' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker
     */
    protected function get1C81ae542386ffdf5a97fb9b1bdcec465b5ac6aba3d4e981fd9919c94e0849f3fService()
    {
        return $this->services['1_c81ae542386ffdf5a97fb9b1bdcec465b5ac6aba3d4e981fd9919c94e0849f3f'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the private '2_c81ae542386ffdf5a97fb9b1bdcec465b5ac6aba3d4e981fd9919c94e0849f3f' shared service.
     *
     * @return \Symfony\Component\Config\Resource\SelfCheckingResourceChecker
     */
    protected function get2C81ae542386ffdf5a97fb9b1bdcec465b5ac6aba3d4e981fd9919c94e0849f3fService()
    {
        return $this->services['2_c81ae542386ffdf5a97fb9b1bdcec465b5ac6aba3d4e981fd9919c94e0849f3f'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }

    /**
     * Gets the private 'AppBundle\Form\MemberType' shared autowired service.
     *
     * @return \AppBundle\Form\MemberType
     */
    protected function getAppBundle_Form_MemberTypeService()
    {
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('HNMAelycbm', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wmnJ35dfxo', 0, 'qwCyKMOe1muxfedjmrymnF', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('je1BNQIJPG', 0, 'qwCyKMOe1muxfedjmrymnF', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tKJMvgFbSi', 0, 'qwCyKMOe1muxfedjmrymnF', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a2fe733b312e4.98897248');
    }
    ...
    {
        return $this->services['security.user.provider.concrete.db_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->get('doctrine')) && false ?: '_'}, 'AppBundle:Member', 'username', NULL);
    }
    ...
    protected function getSecurity_User_Provider_Concrete_InMemoryService()
    {
        ...
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('admin', '$2y$13$sBG1nMvGxgY.AprC/tYl5ecuDvxT66bYNRrdX0zAyQCqQiUX./fqS', array(0 => 'ROLE_ADMIN')));
